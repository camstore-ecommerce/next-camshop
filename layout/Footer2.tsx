  ...
  return (
    <div className='flex flex-col py-2 gap-4 text-small md:text-base md:px-28'>
      <div className='flex flex-col md:flex-row gap-2 justify-between'>
        ...
        <div className='flex-1 mx-3 gap-4'>
          ...
          <div className='flex flex-col gap-2 mt-4'>
            <a
              ...
              className=' flex items-center gap-2 hover:underline hover:font-bold'
              rel='noreferrer'
            >
              <FaMapMarkerAlt className='shrink-0 text-default-500' size={20} />
              <p className='w-3/4'>
                Han Thuyen Street, Quarter 6P, Thu Duc, Ho Chi Minh City
              </p>
            </a>
            <a
              href='mailto:camshop@gm.com'
              className='flex justify-start items-center gap-2 hover:underline hover:font-bold'
            >
              <MailFilledIcon className='shrink-0 text-default-500 text-xl' />
              <p>camshop@gm.com</p>
            </a>
            <a
      ...
      <Link
        className='flex justify-center items-center gap-1 text-current'
        href='/'
        title='Copyright'
      >
        <FaCopyright />
